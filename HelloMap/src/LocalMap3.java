...
public class LocalMap3 extends JPanel {
     ...
     private JLabel busanImageLabel;
      private ImageIcon busanBackGroundImage;
   ...
   public LocalMap3(PrimaryPanel p)
   {
      primary = p;
      ...
      LocalName = new JLabel("\"부 산\"");
          LocalName.setFont(new Font("a타임머신",Font.PLAIN,50));
          LocalName.setBounds(200, 0, 500, 300);
          add(LocalName);
          busanBackGroundImage = new ImageIcon("Images/부산지도.png"); 
          busanImageLabel = new JLabel(busanBackGroundImage);
          busanImageLabel.setBounds(10, 200, 600, 500);
          add(busanImageLabel); //jeju image insertion
