...
public class LocalMap1 extends JPanel {
      ...
      private JLabel seoulImageLabel;
      private ImageIcon seoulBackGroundImage;
   ...
   public LocalMap1(PrimaryPanel p)
   {
      primary = p;
      ...
      goBack.setFont(fnt);
       ...
       LocalName = new JLabel("\"서 울\"");
      LocalName.setFont(new Font("a타임머신",Font.PLAIN,50));
      LocalName.setBounds(200, 0, 500, 300);
      add(LocalName);
      seoulBackGroundImage = new ImageIcon("Images/서울지도.png"); 
      seoulImageLabel = new JLabel(seoulBackGroundImage);
      seoulImageLabel.setBounds(10, 200, 600, 500);
      add(seoulImageLabel); //jeju image insertion
