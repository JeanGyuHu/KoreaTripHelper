...
public class LocalMap2 extends JPanel {
      ...
      private JLabel gimchunImageLabel;
      private ImageIcon gimchunBackGroundImage;
   ...
   public LocalMap2(PrimaryPanel p)
   {
      primary = p;
    ...
    LocalName = new JLabel("\"김 천\"");
          LocalName.setFont(new Font("a타임머신",Font.PLAIN,50));
          LocalName.setBounds(200, 0, 500, 300);
          add(LocalName);
          gimchunBackGroundImage = new ImageIcon("Images/김천.png"); 
          gimchunImageLabel = new JLabel(gimchunBackGroundImage);
          gimchunImageLabel.setBounds(10, 200, 600, 500);
          add(gimchunImageLabel);
